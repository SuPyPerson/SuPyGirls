...
Este lançamento inaugura uma interface renovada, integrando o acesso
à várias plataformas que estavam sendo desenvolvidas em separado. Devido à esta
mudança estrutural a vesão foi atualizada de 1.x.x para 2.0.0
...
Próximo Lançamento: Maio 2018 :ref:`Lançamento 2.1.0 <release2.1.0>`

Lançamento Anterior: Fevereiro 2018 :ref:`Lançamento 1.1.3 <release1_1_3>`
